...
os.system('cls')
os.system(f"title EveryDowm - Tikload^| HengSok ^| Status: Running ^| Version: 1.2")
print(f"""
 {Fore.BLUE}+----------------------------------------------------------------------------------------+
 |                                                                                        |{Fore.BLUE}
 |                    {Fore.CYAN}░█▀▀▀ ▀█─█▀ █▀▀ █▀▀█ █──█ ░█▀▀▄ █▀▀█ █───█ █▀▄▀█{Fore.BLUE}                    |
 |                    {Fore.CYAN}░█▀▀▀ ─█▄█─ █▀▀ █▄▄▀ █▄▄█ ░█─░█ █──█ █▄█▄█ █─▀─█{Fore.BLUE}                    |
 |                    {Fore.CYAN}░█▄▄▄ ──▀── ▀▀▀ ▀─▀▀ ▄▄▄█ ░█▄▄▀ ▀▀▀▀ ─▀─▀─ ▀───▀{Fore.BLUE}                    |
 |                                     {Fore.MAGENTA}Premium V1.2{Fore.BLUE}                                       |
 +----------------------------------------------------------------------------------------+""")  
...
def TiktokMenu():
 ...
 |        {Fore.CYAN}─░█── ▀█▀ █▀▄ ──█── █──█ █▀▄   ░█─░█ █──█ █▄█▄█ █──█ █── █──█ █▄▄█ █──█{Fore.BLUE}         | 
 |        {Fore.CYAN}─░█── ▀▀▀ ▀─▀ ──▀── ▀▀▀▀ ▀─▀   ░█▄▄▀ ▀▀▀▀ ─▀─▀─ ▀──▀ ▀▀▀ ▀▀▀▀ ▀──▀░█▄▄▀{Fore.BLUE}         |
 |                                   {Fore.GREEN}Premium V1.2{Fore.BLUE}                                         |
 +----------------------------------------------------------------------------------------+""")
    while True:
...
print(f"""    
{Fore.YELLOW}Select An Option :
    [{Fore.BLUE}1{Fore.YELLOW}] Tiktok
    [{Fore.BLUE}2{Fore.YELLOW}] Douyin ({Fore.RED}Upcoming{Fore.YELLOW})
    [{Fore.BLUE}3{Fore.YELLOW}] Youtube ({Fore.RED}Upcoming{Fore.YELLOW})
    [{Fore.BLUE}4{Fore.YELLOW}] Kuaishou ({Fore.RED}Upcoming{Fore.YELLOW})
    [{Fore.BLUE}5{Fore.YELLOW}] Kwai ({Fore.RED}Upcoming{Fore.YELLOW})
    [{Fore.BLUE}6{Fore.YELLOW}] Close the Script\n""")
choice = None
while choice != 1 and choice != 2 and choice != 3 and choice != 4 and choice != 5 and choice != 6:
    choice = int(input(f"{Fore.YELLOW}[{Fore.BLUE}=>{Fore.YELLOW}]{Fore.RED} "))
