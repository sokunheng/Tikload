...
{Fore.YELLOW}Select An Option To Download the video :
   ...
   [{Fore.BLUE}2{Fore.YELLOW}] Without Watermark\n""")
    ...
    print(f"""\n{Fore.YELLOW}[{Fore.BLUE}✓{Fore.YELLOW}] Video Downloaded Successfully!""")
...
{Fore.YELLOW}Select An Option To Download the video :
   ...
   [{Fore.BLUE}2{Fore.YELLOW}] Without Watermark\n""")
    ...
    print(f"""{Fore.RED}{username} {Fore.YELLOW}Have {Fore.BLUE}{len(videos)} {Fore.YELLOW}Published Videos. Downloading them... Videos Already Downloaded Will Be Skipped.\n""")
    ...
    if with_watermark == 1:
        for video in videos:
            ...
            with open(f'./downloads/users/{username}/wm/{uri}.mp4', 'wb') as out_file:
                video_bytes = requests.get(download_url, stream=True)
                out_file.write(video_bytes.content)
                print(f"{Fore.YELLOW}[{Fore.BLUE}✓{Fore.YELLOW}] Video Number {count} downloaded")
    else:
        for video in videos:
            count += 1
    ...
    print()
    print(f"{Fore.YELLOW}[{Fore.BLUE}✓{Fore.YELLOW}] Successfully Updated/Downloaded All Videos From {Fore.RED}{username}")
